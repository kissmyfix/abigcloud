# state_audits/portland_city/

## Purpose
City of Portland audit — a third Sumner County data point, and the city whose IDB carries the conduit debt behind the Sumner control group.

## Contents
- `1827-2025-c-portland-rpt-cpa6-3-30-26.pdf` — FY2025, 102 pages, born-digital. `1827` is the Comptroller's entity number.
...
- **DIGITAL.** Extraction is authoritative.
