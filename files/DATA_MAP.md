...
| `files/bin/whos-editing.sh` | Exits non-zero if mdlive has a given file open. Run it before any scripted edit to a content file; writing behind a live buffer him races his autosave. |
