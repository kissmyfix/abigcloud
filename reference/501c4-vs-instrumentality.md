# 501(c)(4) vs. Government Instrumentality (why an IDB's IRS status is a tell)

An [Industrial Development Board](what-is-an-idb.md) ordinarily owes no federal filings at all — not because it's a charity, but because it isn't really a separate thing from its government. Two federal provisions do that work:
...
**Sources:** IRC § 115; Rev. Proc. 95-48; Gallatin IDB Forms 990 2020–2024 (`usa_federal/irs_990_data/gallatin_idb/`); ProPublica TN IDB survey (`usa_federal/irs_990_data/irs_supporting_docs/irs990-501c-tn.png`).
