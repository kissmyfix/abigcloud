...
From the [TVA's $1.1 billion dollar overhaul of the Gallatin Steam Plant](/sources/2013-04-07-timesfreepress-tva-1b-gallatin-steam-plant-upgrade/) to a [a major water pipeline being buried running uphill](/sources/growing-pains-exploring-the-challenges-in-a-thriving-sumner-county-the-truth-about-growth-in-small-cities-with-mayor-mike-callis/) to the [University of Tennessee's internal power struggle](/sources/fenton-on-podcast-full/) and everything in between that this investigation touches on, the scale and scope is, quite frankly, mind boggling.
