---
title: 'TVA'
description: 'The 18% misquote, the largest capital program in TVA history, and what eminent domain looks like when it arrives on a 239-year-old farm.'
heroImage: '../assets/banners/tva-coal-barges.jpg'
heroImageNarrow: '../assets/banners/tva-coal-barges-narrow.jpg'
---
...
>
> Don Moul, TVA President and CEO, Q1 FY2026 Earnings Call, February 4, 2026
...
|---|---|
| **18%** | of TVA's *industrial* load. This is what was reported as total. How it was written. |
| **~10%** | of TVA's *total* load. The correct apples-to-apples number. What it actually means. |
| **4.4%** | of total U.S. electricity. The national baseline for comparison. |

> **Why the Corrected Version Is Actually More Damning**
>
> The instinct to say "18% is a lie" is understandable but imprecise. The more accurate and more powerful version: even the *real* number, 10% of total TVA load, is more than **double the national average**. Tennessee is carrying a disproportionate share of the nation's data center infrastructure load. That story gets buried when "18% of industrial load" gets copied without the qualifier. The misrepresentation did not exaggerate a nothing story. It obscured a legitimate one.
...
|---|---|---|
| Gas plant at Cumberland Fossil (replacing coal) | 1,500 MW | ~1.1 to 1.2 million homes |
| Kingston Energy Complex (gas) | 1,500 MW | ~1.1 to 1.2 million homes |
| Remaining solar, storage, other | ~700 MW | ~525,000 to 560,000 homes |
| **Total under construction** | **3,700 MW** | **~2.8 to 3.0 million homes** |
| Full pipeline including planned | 6,200 MW | ~4.7 to 5.0 million homes |
...
> **Open Thread: TVA Board Firings and the Stalled Rate Class**
>
